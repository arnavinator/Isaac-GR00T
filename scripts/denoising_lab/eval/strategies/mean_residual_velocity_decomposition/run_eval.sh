#!/usr/bin/env bash
# Run the reproducible benchmark for the mean-residual velocity decomposition strategy.
...
gr00t/eval/sim/robocasa/robocasa_uv/.venv/bin/python \
    ...
    --output-dir ~/my_Isaac-GR00T/scripts/denoising_lab/eval/benchmark_results/mean_residual_velocity_decomposition \
    --strategy-name mean_residual_velocity_decomposition \
    "$@"
