#!/usr/bin/env bash
# Launch the GR00T N1.6 server with mean-residual velocity decomposition.
...
uv run python scripts/denoising_lab/eval/strategies/mean_residual_velocity_decomposition/run_server.py \
