#!/usr/bin/env bash
# Run the reproducible benchmark for the receding-horizon warm-start strategy.
...
#   bash scripts/denoising_lab/eval/strategies/receding_horizon_warm_start/run_eval.sh --n-episodes 50
set -euo pipefail
...
gr00t/eval/sim/robocasa/robocasa_uv/.venv/bin/python \
    ...
    --output-dir ~/my_Isaac-GR00T/scripts/denoising_lab/eval/benchmark_results/receding_horizon_warm_start \
