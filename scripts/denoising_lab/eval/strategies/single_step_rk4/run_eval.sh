#!/usr/bin/env bash
# Run the reproducible benchmark for the single-step RK4 strategy.
...
#   bash scripts/denoising_lab/eval/strategies/single_step_rk4/run_eval.sh --n-episodes 50
set -euo pipefail
...
gr00t/eval/sim/robocasa/robocasa_uv/.venv/bin/python \
    ...
    --output-dir ~/my_Isaac-GR00T/scripts/denoising_lab/eval/benchmark_results/single_step_rk4 \
