#!/usr/bin/env bash
# Launch the GR00T N1.6 server with analytic constraint guidance.
...
uv run python scripts/denoising_lab/eval/strategies/analytic_constraint_guidance/run_server.py \
