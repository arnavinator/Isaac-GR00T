#!/usr/bin/env bash
# Run the reproducible benchmark for the spectral temporal decomposition strategy.
...
gr00t/eval/sim/robocasa/robocasa_uv/.venv/bin/python \
    ...
    --output-dir ~/my_Isaac-GR00T/scripts/denoising_lab/eval/benchmark_results/spectral_temporal_decomposition \
    --strategy-name spectral_temporal_decomposition \
    "$@"
