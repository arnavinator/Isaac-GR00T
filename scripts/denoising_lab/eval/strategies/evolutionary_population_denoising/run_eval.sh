#!/usr/bin/env bash
# Run the reproducible benchmark for the evolutionary population denoising strategy.
...
gr00t/eval/sim/robocasa/robocasa_uv/.venv/bin/python \
    ...
    --output-dir ~/my_Isaac-GR00T/scripts/denoising_lab/eval/benchmark_results/evolutionary_population_denoising \
    --strategy-name evolutionary_population_denoising \
    "$@"
