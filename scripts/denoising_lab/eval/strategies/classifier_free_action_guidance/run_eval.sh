#!/usr/bin/env bash
# Run the reproducible benchmark for the classifier-free action guidance strategy.
...
gr00t/eval/sim/robocasa/robocasa_uv/.venv/bin/python \
    ...
    --output-dir ~/my_Isaac-GR00T/scripts/denoising_lab/eval/benchmark_results/classifier_free_action_guidance \
    --strategy-name classifier_free_action_guidance \
    "$@"
