#!/usr/bin/env bash
# Run the reproducible benchmark for the density-aware denoising strategy.
...
gr00t/eval/sim/robocasa/robocasa_uv/.venv/bin/python \
    ...
    --output-dir ~/my_Isaac-GR00T/scripts/denoising_lab/eval/benchmark_results/density_aware_denoising \
    --strategy-name density_aware_denoising \
    "$@"
