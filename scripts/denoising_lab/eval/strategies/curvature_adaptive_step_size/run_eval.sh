#!/usr/bin/env bash
# Run the reproducible benchmark for the curvature-adaptive step-size strategy.
...
gr00t/eval/sim/robocasa/robocasa_uv/.venv/bin/python \
    ...
    --output-dir ~/my_Isaac-GR00T/scripts/denoising_lab/eval/benchmark_results/curvature_adaptive_step_size \
    --strategy-name curvature_adaptive_step_size \
    "$@"
